...
namespace ServiceRest_20190140047_FuadRizkani
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-4BTVQVSS\\SQLEXPRESS;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=elfuede92");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-4BTVQVSS\\SQLEXPRESS;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=elfuede92");
